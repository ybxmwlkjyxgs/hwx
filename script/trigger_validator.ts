module validator {
	...
	//$$hwx_6151.spell.冰锥.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.加剧.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.双枪.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.放大.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.暗影之镰.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.火球.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.热血.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.祝福.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.粒子束.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.过载.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.雷之怒.root:Data.Game.Formulas.Mana
	//$$hwx_6151.spell.风火轮.root:Data.Game.Formulas.Mana
	...
	//$$hwx_6151.spell.冰锥.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.加剧.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.双枪.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.放大.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.暗影之镰.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.火球.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.热血.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.祝福.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.粒子束.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.过载.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.雷之怒.root:Data.Game.Formulas.Cooldown
	//$$hwx_6151.spell.风火轮.root:Data.Game.Formulas.Cooldown
	...
	//$$hwx_6151.spell.冰锥.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.加剧.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.双枪.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.放大.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.暗影之镰.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.火球.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.热血.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.祝福.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.粒子束.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.过载.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.雷之怒.root:Data.Game.Formulas.ChargeMax
	//$$hwx_6151.spell.风火轮.root:Data.Game.Formulas.ChargeMax
	...
	//$$hwx_6151.spell.冰锥.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.加剧.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.双枪.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.放大.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.暗影之镰.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.火球.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.热血.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.祝福.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.粒子束.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.过载.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.雷之怒.root:Data.Game.Formulas.Range
	//$$hwx_6151.spell.风火轮.root:Data.Game.Formulas.Range
	...
	//$$hwx_6151.spell.冰锥.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.加剧.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.双枪.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.放大.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.暗影之镰.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.火球.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.热血.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.祝福.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.粒子束.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.过载.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.雷之怒.root:Data.Game.Formulas.Time
	//$$hwx_6151.spell.风火轮.root:Data.Game.Formulas.Time
	...
	//$$hwx_6151.item.回复药水.EffectUnitModifyAttribute:Data.Game.KeyValuePairs[1].Value
	/** @noSelf */
	export let validator_116504458:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let 基础值: number = 0;
		let 倍率: number = 0;
		let result: number = 0;
		if (((单位 != undefined))) {
			基础值 = 100;
			倍率 = 单位.get_ex(单位属性["治疗倍率"], UnitPropertySubType["Final"]);
			result = (基础值 * 倍率);
		} else {
		}
		return result;
	...
	/** @noSelf */
	export let validator_111761753:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let spell: Skill = 效果节点.skill();
		let cache: _OBJ__spell_spell = spell.cache;
		let is_combo: boolean = cache.MultiPhaseSetting.IsMultiPhase;
		let combo: number = spell.phase;
		...
		if (((is_combo == true))) {
			...
			s[1] = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)].SpellTime.cast_shot_time;
			s[1] = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)].SpellTime.cast_finish_time;
			cooldown = cache.MultiPhaseSetting.MultiPhaseConfig[(combo - 1)].Cooldown;
		} else {
			s[1] = cache.Time.cast_start_time;
			s[2] = cache.Time.cast_channel_time;
	...
	/** @noSelf */
	export let validator_156398715:(this: void, 效果节点:EffectParam, 引发响应的效果节点:EffectParam, 原始伤害值:number, 当前伤害值:number)=>number = (this: void, 效果节点:EffectParam, 引发响应的效果节点:EffectParam, 原始伤害值:number, 当前伤害值:number):number => {
		let result: number = 1;
		base.eff_param_caster(效果节点).add_ex(单位属性["生命"], (原始伤害值 * 0.15), UnitPropertySubType["Base"]);
		return result;
	}
	...
	//$$hwx_6151.spell.冰锥.EffectPersistLoop:Data.Game.PersistValidator
	//$$hwx_6151.spell.暗影之镰.PersistLoop:Data.Game.PersistValidator
	//$$hwx_6151.spell.雷之怒.EffectPersistLoop:Data.Game.PersistValidator
	//$$hwx_6151.spell.风火轮.EffectPersistLoop:Data.Game.PersistValidator
	/** @noSelf */
	export let validator_241042370:(this: void, 效果节点:EffectParam)=>验证器代码 = (this: void, 效果节点:EffectParam):验证器代码 => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		if ((((单位 != undefined) && (单位.is_alive_ex() == true)))) {
			return 验证器代码["OK"];
		} else {
			return 验证器代码["NotSupported"];
		}
	...
	//$$hwx_6151.spell.冰锥.LaunchMissile:Data.Game.ImpactSearchRange
	//$$hwx_6151.spell.火球.EffectLaunchMissile:Data.Game.ImpactSearchRange
	/** @noSelf */
	export let validator_11144354:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let 基础值: number = 0;
		let 倍率: number = 0;
		let result: number = 0;
		if (((单位 != undefined))) {
			基础值 = 15;
			倍率 = 单位.get_ex(单位属性["效果范围"], UnitPropertySubType["Final"]);
			result = (基础值 * 倍率);
		} else {
		}
		return result;
	...
	//$$hwx_6151.spell.冰锥.LaunchMissile:Data.Game.MissileScaling
	//$$hwx_6151.spell.火球.EffectLaunchMissile:Data.Game.MissileScaling
	//$$hwx_6151.spell.风火轮.MoverFollow:Data.Game.MissileScaling
	/** @noSelf */
	export let validator_93494875:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let 倍率: number = 0;
		if (((单位 != undefined))) {
			倍率 = 单位.get_ex(单位属性["效果范围"], UnitPropertySubType["Final"]);
	...
	//$$hwx_6151.spell.怪物默认攻击.Damage:Data.Game.Amount
	/** @noSelf */
	export let validator_49744114:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let 目标: Unit | undefined = base.eff_param_target_unit(效果节点);
		let 距离: number = 0;
		let 约束距离: number = 0;
		let 倍率: number = 0;
		let result: number = 0;
		if ((((单位 != undefined) && (目标 != undefined)))) {
			距离 = 单位.get_scene_point().distance(目标.get_scene_point());
			约束距离 = base.math.max(base.math.min((距离 - 单位.get_attackable_radius()), 50), 0);
			倍率 = (10 + ((50 - 约束距离) / 5));
			result = (单位.get_ex(单位属性["攻击"], UnitPropertySubType["Final"]) * 倍率);
		} else {
		}
		return result;
	}

	//$$hwx_6151.spell.怪物默认攻击.root:Data.Game.Formulas.Mana
	/** @noSelf */
	export let validator_205687354:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let result: number = 0;
		return result;
	}

	//$$hwx_6151.spell.怪物默认攻击.root:Data.Game.Formulas.Cooldown
	/** @noSelf */
	export let validator_171930303:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let result: number = 0.25;
		return result;
	}

	//$$hwx_6151.spell.怪物默认攻击.root:Data.Game.Formulas.ChargeMax
	/** @noSelf */
	export let validator_206006793:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let result: number = 1;
		return result;
	}

	//$$hwx_6151.spell.怪物默认攻击.root:Data.Game.Formulas.Range
	/** @noSelf */
	export let validator_46030309:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let result: number = 0;
		if (((单位 != undefined))) {
	...
	//$$hwx_6151.spell.怪物默认攻击.root:Data.Game.Formulas.Time
	/** @noSelf */
	export let validator_109912444:(this: void, 效果节点:EffectParam, 阶段:number)=>number = (this: void, 效果节点:EffectParam, 阶段:number):number => {
		let result: number = 0;
		return result;
	}

	//$$hwx_6151.spell.暗影之镰.MoverTo:Data.Game.hit_area
	/** @noSelf */
	export let validator_188926625:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let 基础值: number = 0;
		let 倍率: number = 0;
		let result: number = 0;
	...
	//$$hwx_6151.spell.暗影之镰.MoverTo:Data.Game.MissileScaling
	/** @noSelf */
	export let validator_246540614:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let 基础值: number = 0;
		let 倍率: number = 0;
		let result: number = 0;
	...
	//$$hwx_6151.spell.暗影之镰.PolarOffset:Data.Game.Angle.LocalOffset
	/** @noSelf */
	export let validator_142193451:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let result: number = base.math.random_float(0, 360);
		return result;
	}

	//$$hwx_6151.spell.火球.EffectPersistLoop:Data.Game.PersistValidator
	/** @noSelf */
	export let validator_67150263:(this: void, 效果节点:EffectParam)=>验证器代码 = (this: void, 效果节点:EffectParam):验证器代码 => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		if ((((单位 != undefined) && (单位.is_alive_ex() == true)))) {
			return 验证器代码["OK"];
		} else {
	...
	//$$hwx_6151.spell.火球.EffectPolarOffset:Data.Game.PeriodicAngleChange
	/** @noSelf */
	export let validator_123360266:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 等级: number = 效果节点.get_level();
		let result: number = (((等级 + 1) * 10) / 等级);
		return result;
	}

	//$$hwx_6151.spell.风火轮.EffectPolarOffset:Data.Game.PeriodicAngleChange
	/** @noSelf */
	export let validator_137894438:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 等级: number = 效果节点.get_level();
		let result: number = (360 / 等级);
		return result;
	}

	//$$hwx_6151.spell.风火轮.MoverFollow:Data.Game.hit_area
	/** @noSelf */
	export let validator_75758185:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let 基础值: number = 0;
		let 倍率: number = 0;
		let result: number = 0;
	...
	//$$hwx_6151.unit.默认英雄.ResponseDamage:Data.Game.Multiplier
	/** @noSelf */
	export let validator_154092975:(this: void, 效果节点:EffectParam)=>number = (this: void, 效果节点:EffectParam):number => {
		let 单位: Unit | undefined = base.eff_param_caster(效果节点);
		let result: number = 0;
		if (((单位 != undefined))) {
			result = 单位.get_ex(单位属性["攻击"], UnitPropertySubType["Final"]);
		} else {
		}
		return result;
	}
	...
	function init_validator_0() {
		...
		if (data = base.eff.cache("$$hwx_6151.spell.冰锥.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.加剧.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.双枪.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.放大.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.暗影之镰.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.火球.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.热血.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.祝福.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.粒子束.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.过载.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.雷之怒.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$hwx_6151.spell.风火轮.root")) {
			data.Formulas.Mana = validator_67644446
			data.Formulas.Cooldown = validator_45417306
			data.Formulas.ChargeMax = validator_211391127
			data.Formulas.Range = validator_63878418
		...
		if (data = base.eff.cache("$$default_units_ts.template@spell.通用近战普攻模版.root")) {
			...
			data.Formulas.Cooldown = validator_111761753
		...
		if (data = base.eff.cache("$$hwx_6151.item.回复药水.EffectUnitModifyAttribute")) {
			data.KeyValuePairs[1].Value = validator_116504458
		}
		...
		if (data = base.eff.cache("$$default_units_ts.spell.吸血光环.ResponseDamageAttacker_1")) {
			data.Modification = validator_156398715
		}
		...
		if (data = base.eff.cache("$$hwx_6151.spell.冰锥.EffectPersistLoop")) {
			data.PersistValidator = validator_241042370
		}
		if (data = base.eff.cache("$$hwx_6151.spell.暗影之镰.PersistLoop")) {
			data.PersistValidator = validator_241042370
		}
		if (data = base.eff.cache("$$hwx_6151.spell.雷之怒.EffectPersistLoop")) {
			data.PersistValidator = validator_241042370
		}
		if (data = base.eff.cache("$$hwx_6151.spell.风火轮.EffectPersistLoop")) {
			data.PersistValidator = validator_241042370
		}
		if (data = base.eff.cache("$$hwx_6151.spell.冰锥.LaunchMissile")) {
			data.ImpactSearchRange = validator_11144354
			data.MissileScaling = validator_93494875
		}
		if (data = base.eff.cache("$$hwx_6151.spell.火球.EffectLaunchMissile")) {
			data.ImpactSearchRange = validator_11144354
			data.MissileScaling = validator_93494875
		}
		if (data = base.eff.cache("$$hwx_6151.spell.风火轮.MoverFollow")) {
			data.MissileScaling = validator_93494875
			data.hit_area = validator_75758185
		}
		if (data = base.eff.cache("$$hwx_6151.spell.怪物默认攻击.Damage")) {
			data.Amount = validator_49744114
		}
		if (data = base.eff.cache("$$hwx_6151.spell.怪物默认攻击.root")) {
			data.Formulas.Mana = validator_205687354
			data.Formulas.Cooldown = validator_171930303
			data.Formulas.ChargeMax = validator_206006793
			data.Formulas.Range = validator_46030309
			data.Formulas.Time = validator_109912444
		}
		if (data = base.eff.cache("$$hwx_6151.spell.暗影之镰.MoverTo")) {
			data.hit_area = validator_188926625
			data.MissileScaling = validator_246540614
		}
		if (data = base.eff.cache("$$hwx_6151.spell.暗影之镰.PolarOffset")) {
			data.Angle.LocalOffset = validator_142193451
		}
		if (data = base.eff.cache("$$hwx_6151.spell.火球.EffectPersistLoop")) {
			data.PersistValidator = validator_67150263
		}
		if (data = base.eff.cache("$$hwx_6151.spell.火球.EffectPolarOffset")) {
			data.PeriodicAngleChange = validator_123360266
		}
		if (data = base.eff.cache("$$hwx_6151.spell.风火轮.EffectPolarOffset")) {
			data.PeriodicAngleChange = validator_137894438
		}
		...
		if (data = base.eff.cache("$$hwx_6151.unit.默认英雄.ResponseDamage")) {
			data.Multiplier = validator_154092975
		}
	}
	init_validator_0()
}
